...
class CarMakerROSInterface : public CarMakerCPPInterface {
 public:
   ...
   * all registered jobs associated with CMJob::CallbackHook::StartCycle and
   ...
   * CMJob::CallbackHook::Out and CMJob::CallbackHook::EndCycle that are due in
   * the current cycle and updates all registered jobs.
   */
  void out() final;
