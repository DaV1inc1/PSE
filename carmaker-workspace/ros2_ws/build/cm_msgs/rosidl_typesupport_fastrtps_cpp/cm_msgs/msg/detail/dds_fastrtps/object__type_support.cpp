...
#include "cm_msgs/msg/detail/object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cm_msgs::msg::Object & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cm_msgs::msg::Object & ros_message)
{
  // Member: object
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cm_msgs::msg::Object;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cm_msgs::msg::Object *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cm_msgs::msg::Object *>(
    untyped_ros_message);
...
{
  return &cm_msgs::msg::typesupport_fastrtps_cpp::_Object__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cm_msgs, msg, Object)() {
  return &cm_msgs::msg::typesupport_fastrtps_cpp::_Object__handle;
}
