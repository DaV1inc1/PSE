...
#include "cm_msgs/msg/detail/vehicle_input__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cm_msgs
cdr_serialize(
  const cm_msgs::msg::VehicleInput & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cm_msgs::msg::VehicleInput & ros_message)
{
  // Member: gas
  cdr >> ros_message.gas;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cm_msgs::msg::VehicleInput;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cm_msgs::msg::VehicleInput *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cm_msgs::msg::VehicleInput *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_cm_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<cm_msgs::msg::VehicleInput>()
{
  return &cm_msgs::msg::typesupport_fastrtps_cpp::_VehicleInput__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cm_msgs, msg, VehicleInput)() {
  return &cm_msgs::msg::typesupport_fastrtps_cpp::_VehicleInput__handle;
}
