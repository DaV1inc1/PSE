...
{
  new (message_memory) cm_msgs::msg::Object(_init);
}

void Object_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cm_msgs::msg::Object *>(message_memory);
  typed_message->~Object();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Object_message_member_array[1] = {
  {
    "object",  // name
    ...
    offsetof(cm_msgs::msg::Object, object),  // bytes offset in struct
...
get_message_type_support_handle<cm_msgs::msg::Object>()
{
  return &::cm_msgs::msg::rosidl_typesupport_introspection_cpp::Object_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cm_msgs, msg, Object)() {
  return &::cm_msgs::msg::rosidl_typesupport_introspection_cpp::Object_message_type_support_handle;
}
