...
{
  new (message_memory) cm_msgs::msg::VehicleState(_init);
}

void VehicleState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cm_msgs::msg::VehicleState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleState_message_member_array[1] = {
  {
    ...
    offsetof(cm_msgs::msg::VehicleState, velocity),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleState_message_members = {
  ...
  1,  // number of fields
  sizeof(cm_msgs::msg::VehicleState),
...
{
  return &::cm_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cm_msgs, msg, VehicleState)() {
  return &::cm_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleState_message_type_support_handle;
}
