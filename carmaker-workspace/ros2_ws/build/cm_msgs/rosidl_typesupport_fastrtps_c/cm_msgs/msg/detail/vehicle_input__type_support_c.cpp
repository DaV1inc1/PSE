...
#include "cm_msgs/msg/detail/vehicle_input__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleInput__ros_msg_type = cm_msgs__msg__VehicleInput;
...
size_t get_serialized_size_cm_msgs__msg__VehicleInput(
  const void * untyped_ros_message,
...
static uint32_t _VehicleInput__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cm_msgs__msg__VehicleInput(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cm_msgs
size_t max_serialized_size_cm_msgs__msg__VehicleInput(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cm_msgs__msg__VehicleInput;
    is_plain =
      (
...
static size_t _VehicleInput__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cm_msgs__msg__VehicleInput(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cm_msgs, msg, VehicleInput)() {
