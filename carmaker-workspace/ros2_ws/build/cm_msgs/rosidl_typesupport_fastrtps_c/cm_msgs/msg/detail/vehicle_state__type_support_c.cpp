...
#include "cm_msgs/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleState__ros_msg_type = cm_msgs__msg__VehicleState;
...
size_t get_serialized_size_cm_msgs__msg__VehicleState(
  const void * untyped_ros_message,
...
static uint32_t _VehicleState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cm_msgs__msg__VehicleState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cm_msgs
size_t max_serialized_size_cm_msgs__msg__VehicleState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cm_msgs__msg__VehicleState;
    is_plain =
      (
...
static size_t _VehicleState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cm_msgs__msg__VehicleState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cm_msgs, msg, VehicleState)() {
